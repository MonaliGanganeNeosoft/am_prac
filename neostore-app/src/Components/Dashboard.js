...
function Dashboard() {
  ...
  return (
    <div>
      ...
      <Container fluid>
        {show == true && (
          <Alert className="fw-bold" style={{ fontSize: "25px" }}>
            Woahhh ! Product Added in Cart
          </Alert>
        )}
        ...
        {products != undefined &&
          products.map((pro, index) => (
            ...
            >
              ...
              <Card.Body>
                <p>{pro.productName}</p>
                <Card.Text>Price: {pro.productCost}</Card.Text>
                <Card.Text>
                  <Rating
                    name="read-only"
                ...
                <Button onClick={() => addToCart(pro)} variant="primary">
                  Add to Cart
                </Button>
              </Card.Body>
            </Card>
